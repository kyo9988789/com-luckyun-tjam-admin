...
public class AmAssetLeave extends DocEntity{
    ...
    @Describe("调出类型（1.内部 2,捐赠(外部) 3,无偿(外部) 4,投资(外部) 5,租赁(外部)）")
    private Integer ileavetypeid;
    @Virtual
    private String sleavetypenm;
