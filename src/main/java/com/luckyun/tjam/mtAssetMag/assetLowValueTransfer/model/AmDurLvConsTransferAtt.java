package com.luckyun.tjam.mtAssetMag.assetLowValueTransfer.model;
...
public class AmDurLvConsTransferAtt extends DocEntity{
    ...
    public String __getTableName() {
        return "am_dur_lv_cons_transfer_att";
    }
}
