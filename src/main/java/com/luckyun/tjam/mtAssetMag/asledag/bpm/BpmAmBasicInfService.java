package com.luckyun.tjam.mtAssetMag.asledag.bpm;
 ...
 */
@Service
public class BpmAmBasicInfService extends BpmEventQueue{
    ...
    private String basekey(){
        ...
        List<String> skeys = this.bpmInstanceResource.getBpmInstanceVariableFeign("BpmAmBasicInfService");
